...
<<<<<<< Updated upstream
        ...
        "llama3-8b-8192"
=======
          Your task is to update the knowledge graph to reflect the changes made by the agents. You should reflect this in the narration.
  ...
  return (
    <main className="">
      <div className="z-10 max-w-lg w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        You should use the generating graph to explain the challenges with this project and always document a timeline starting from 2019 to 2050.
        You should implment the issues generated by the graph to inform your narriration along the years, `}
