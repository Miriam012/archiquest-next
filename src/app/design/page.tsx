  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-100">
      ...
      <p className="text-lg text-center mb-6 max-w-2xl">
        In this gallery, you will find masterplans, sections, and plans of how the project will operate and run globally. You'll also find some AI-generated images that reflect the project's design goals.
      </p>
      <ImageGallery
        items={images}
